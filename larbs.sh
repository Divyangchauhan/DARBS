#!/bin/sh
# Divyang's edit of Luke's Auto Rice Boostrapping Script (LARBS)
# by Divyang Chauhan <divyang@divyangchauhan.com>
# License: GNU GPLv3
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/Divyangchauhan/DARBSConfig.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/Divyangchauhan/DARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Divyang's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop Environment, which I use as my main machine" 10 60
...
dialog --title "DARBS Installation" --infobox "Installing \`basedevel\` and \`git\` for installing other software required for the installation of other programs." 5 7
installpkg curl
